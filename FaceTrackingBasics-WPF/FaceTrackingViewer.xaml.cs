...
namespace FaceTrackingBasics
{
    ...
    public partial class FaceTrackingViewer : UserControl, IDisposable
    {
        ...
        private class SkeletonFaceTracker : IDisposable
        {
            ...
            private string dataToBeSent1;
            private string dataToBeSent2;
            private string dataToBeSent3;

            public string retData1()
            {
                return dataToBeSent1;
            }

            public string retData2()
            {
                return dataToBeSent2;
            }

            public string retData3()
            {
                return dataToBeSent3;
            }
